...
$configuredStatefulDomains = (string) env('SANCTUM_STATEFUL_DOMAINS', $defaultStatefulDomains);
$statefulDomains = array_values(array_unique(array_filter(array_map(
    static fn (string $domain): string => trim($domain),
    explode(',', $configuredStatefulDomains.Sanctum::currentApplicationUrlWithPort().Sanctum::currentRequestHost()),
))));
