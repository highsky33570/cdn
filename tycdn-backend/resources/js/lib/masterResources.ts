...
export const masterResources: Record<string, ResourceDefinition> = {
    ...
    discounts: {
        ...
        fields: [
            ...
            number('month_price', '月付价格（USDT）'),
            number('quarter_price', '季付价格（USDT）'),
            number('year_price', '年付价格（USDT）'),
    ...
    coupons: {
        ...
        fields: [
            ...
            text('discount_value', '折扣值'),
            number('price_gt', '最低消费（USDT）'),
            number('price_value', '抵扣金额（USDT）'),
